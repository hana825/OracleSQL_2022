...
SELECT sc_label FROM view_WorkOut GROUP BY sc_label;

SELECT sc_label,sc_part FROM view_WorkOut WHERE sc_label = '초급';

-- 운동스케쥴  table에서 등급ID + Label + Division 묶어서 한 개씩만 보고 싶을 때
